...
for i in range(samples):
	x[i]=np.random.rand()*samples
	y[i]=np.random.rand()*samples
...
def save_charts(length):
	plt.savefig('scatter_10_B_1.png')
	...
	plt.savefig('avance_infectados_10_B_1.png')
	plt.cla()
	plt.clf()
	...
	plt.savefig('avance_sanos_10_B_1.png')
